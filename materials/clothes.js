      ...
      <g
        ...
        <g id='Shirt' transform='translate(32.000000, 29.000000)'>
          <mask id='BlazerShirt-mask1' fill='white'>
            <use xlink:href='#BlazerShirt-path1' />
          </mask>
          <use class='CustomColor' fill='#E6E6E6' xlink:href='#BlazerShirt-path1' />
...
const BlazerSweater = `
      <g
        ...
        <mask id='BlazerSweater-mask1' fill='white'>
          <use xlink:href='#BlazerSweater-path1' />
        </mask>
        <use
          class='CustomColor'
          fill='#E6E6E6'
          fillRule='evenodd'
          xlink:href='#BlazerSweater-path1'
        />
        <g
...
const CollarSweater = `
      <g
        ...
        <mask id='CollarSweater-mask1' fill='white'>
          <use xlink:href='#CollarSweater-path1' />
        </mask>
        <use
          class='CustomColor'
          fill='#E6E6E6'
          fillRule='evenodd'
          xlink:href='#CollarSweater-path1'
        />
        <path
...
const GraphicShirt = `
      <g
        ...
        <mask id='GraphicShirt-mask1' fill='white'>
          <use xlink:href='#GraphicShirt-path1' />
        </mask>
        <use
          class='CustomColor'
          fill='#E6E6E6'
          fillRule='evenodd'
          xlink:href='#GraphicShirt-path1'
        />
      </g>
`;
const Hoodie = `
      <g id='Clothing/Hoodie' transform='translate(0.000000, 170.000000)'>
        ...
        <mask id='Hoodie-mask1' fill='white'>
          <use xlink:href='#Hoodie-path1' />
        </mask>
        <use
          class='CustomColor'
          fill='#B7C1DB'
          fillRule='evenodd'
          xlink:href='#Hoodie-path1'
        />
        <path
...
const Overall = `
      <g id='Clothing/Overall' transform='translate(0.000000, 170.000000)'>
        ...
        <mask id='Overall-mask1' fill='white'>
          <use xlink:href='#Overall-path1' />
        </mask>
        <use
          class='CustomColor'
          fill='#B7C1DB'
          fillRule='evenodd'
          xlink:href='#Overall-path1'
        />
        <circle
          id='Button'
          fill='#F4F4F4'
...
const ShirtCrewNeck = `
      <g
        ...
        <mask id='ShirtCrewNeck-mask1' fill='white'>
          <use xlink:href='#ShirtCrewNeck-path1' />
        </mask>
        <use
          class='CustomColor'
          fill='#E6E6E6'
          fillRule='evenodd'
          xlink:href='#ShirtCrewNeck-path1'
        />
        <g
          id='Shadowy'
          opacity='0.16'
...
const ShirtScoopNeck = `
      <g
        ...
        <mask id='ShirtScoopNeck-mask1' fill='white'>
          <use xlink:href='#ShirtScoopNeck-path1' />
        </mask>
        <use
          class='CustomColor'
          fill='#E6E6E6'
          fillRule='evenodd'
          xlink:href='#ShirtScoopNeck-path1'
        />
      </g>
`;
const ShirtVNeck = `
      <g id='Clothing/Shirt-V-Neck' transform='translate(0.000000, 170.000000)'>
        ...
        <mask id='ShirtVNeck-mask1' fill='white'>
          <use xlink:href='#ShirtVNeck-path1' />
        </mask>
        <use
          class='CustomColor'
          fill='#E6E6E6'
          fillRule='evenodd'
          xlink:href='#ShirtVNeck-path1'
        />
      </g>
`;

window.clothesType = {//衣服
