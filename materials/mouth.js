...
const Concerned =
  ...
  <g transform='translate(76.000000, 82.000000)'>
		<!-- g代表一个组,相关的元素放在一起,类似Html中的组 -->
      <g id='Mouth/Concerned' transform='translate(2.000000, 52.000000)'>
		<!-- 用来定义一些元素,通过id被其他元素引用,本身不会渲染,被引用后才会渲染-->
        <defs>
		<!--  -->
		<!-- 定义路径 d="定义路径上的所有点的坐标,大写绝对,小写相对" -->
		<!-- M35,15 移动到这个坐标开始画到第一个C曲线图 -->
          <path
            d='M35,15 C36,24 44,32 54,32 C63,32 71,24 72,15 C72.9736685,14.272746 72.1167429,13 71.042767,13 C56.1487536,13 44.7379213,13 37.0868244,13 C36.0066168,13 35.0120058,14.1784435 35.117844,15.1280772 Z'
            id='Mouth1'
          />
        </defs>
		<!-- 复制嘴巴,并翻转 -->
        ...
        <rect
          ...
          rx='5'
        />
		<!-- 舌头 用遮罩元素,画当前的元素到原来的元素上，也就是用新的图形，在原有图形上粘贴覆盖这部分,类似于贴邮票-->
        <g
          id='Tongue'
          strokeWidth='1'
          fillRule='evenodd'
...
const Vomit =
  ...
  <g transform='translate(76.000000, 82.000000)'>
      <g id='Mouth/Vomit' transform='translate(2.000000, 52.000000)'>
        ...
        />
        <g id='Vomit-Stuff'>
          <use fill='#88C553' fillRule='evenodd' xlink:href='#Vomit-path2' />
          <use
            fill='black'
            opacity='1'
            filter='url("#filter1")'
            xlink:href='#Vomit-path2'
          />
        </g>
      </g>
    </g>
